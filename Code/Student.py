...
from problems import pb_pythagoras


class Student():

    def __init__(self,client,pb=pb_pythagoras,level='10th grade student',confusion="lost and unsure how to proceed. You have never done this kind of problem before",emotion=None,model="myGPT4") -> None:
        print("---")
